...
export default function AnalysisScreen({ onComplete }: Props) {
  ...
  return (
    <div className="mystic-gradient min-h-screen flex flex-col items-center justify-center overflow-hidden relative">
      {/* Constellation Background Decoration */}
      <div className="absolute inset-0 pointer-events-none opacity-40">
        <svg className="absolute inset-0" width="100%" height="100%">
          <line className="constellation-line" strokeWidth="0.5" x1="20%" x2="40%" y1="30%" y2="25%" />
          <line className="constellation-line" strokeWidth="0.5" x1="40%" x2="55%" y1="25%" y2="35%" />
          <line className="constellation-line" strokeWidth="0.5" x1="55%" x2="45%" y1="35%" y2="50%" />
          <line className="constellation-line" strokeWidth="0.5" x1="45%" x2="25%" y1="50%" y2="45%" />
          <line className="constellation-line" strokeWidth="0.5" x1="25%" x2="20%" y1="45%" y2="30%" />
          <circle className="star-dot" cx="20%" cy="30%" r="1" />
          <circle className="star-dot" cx="40%" cy="25%" r="1.5" />
          <circle className="star-dot" cx="55%" cy="35%" r="1" />
          <circle className="star-dot" cx="45%" cy="50%" r="1" />
          <circle className="star-dot" cx="25%" cy="45%" r="1.2" />
          <line className="constellation-line" strokeWidth="0.5" x1="75%" x2="85%" y1="65%" y2="55%" />
          <line className="constellation-line" strokeWidth="0.5" x1="85%" x2="70%" y1="55%" y2="45%" />
          <circle className="star-dot" cx="75%" cy="65%" r="1" />
          <circle className="star-dot" cx="85%" cy="55%" r="1.5" />
          <circle className="star-dot" cx="70%" cy="45%" r="1" />
        </svg>
      </div>
      ...
      <main className="relative z-10 flex flex-col items-center justify-center w-full max-w-[430px] px-8 h-screen">
        ...
        <div className="relative mb-20">
          {/* Outer Atmosphere */}
          <div className="absolute -inset-16 crystal-ball-glow rounded-full opacity-60"></div>
          {/* Sphere Body */}
