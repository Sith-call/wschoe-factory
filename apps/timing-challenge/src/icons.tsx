...
export function TapIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M12 2a3 3 0 0 0-3 3v6H7a2 2 0 0 0-2 2v1a8 8 0 0 0 8 8h1a8 8 0 0 0 8-8v-1a2 2 0 0 0-2-2h-2V5a3 3 0 0 0-3-3z" />
      <line x1="12" y1="2" x2="12" y2="8" />
    </svg>
  );
}

export function HoldIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
